...
CONST MTRR_LIB_SYSTEM_PARAMETER mDefaultSystemParameter = {
...
{
  *(UINT32 *) Context = PatchPcdGet32 (PcdCpuNumberOfReservedVariableMtrrs);
  return UNIT_TEST_PASSED;
}
...
{
  PatchPcdSet32 (PcdCpuNumberOfReservedVariableMtrrs, *(UINT32 *) Context);
  return UNIT_TEST_PASSED;
}
