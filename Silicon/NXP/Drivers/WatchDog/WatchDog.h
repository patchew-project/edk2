...
typedef struct {
  UINT16 (*WdogRead) (UINTN Address);
  UINT16 (*WdogWrite) (UINTN Address, UINT16 Value);
  UINT16 (*WdogAndThenOr) (UINTN Address, UINT16 And, UINT16 Or);
  UINT16 (*WdogOr) (UINTN Address, UINT16 Or);
  } WDOG_OPERATION;
