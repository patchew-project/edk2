...
#define MAC_ADDRESS                 (PcdGet32 (PcdEepRomBase) + 0x00)

#define HM_ME_ADDRESS_H             (PcdGet32 (PcdEepRomBase) + 0x08)
#define HM_ME_ADDRESS_L             (PcdGet32 (PcdEepRomBase) + 0x0C)
#define HM_ME_SIZE                  (PcdGet32 (PcdEepRomBase) + 0x10)

#define MH_ME_ADDRESS_H             (PcdGet32 (PcdEepRomBase) + 0x14)
#define MH_ME_ADDRESS_L             (PcdGet32 (PcdEepRomBase) + 0x18)
#define MH_ME_SIZE                  (PcdGet32 (PcdEepRomBase) + 0x1C)

#define PACKET_ME_ADDRESS           (PcdGet32 (PcdEepRomBase) + 0x20)
#define PACKET_ME_SIZE              (PcdGet32 (PcdEepRomBase) + 0x24)
