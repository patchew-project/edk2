...
This option loads the BSF file into the ConfigEditor to change the desired configuration values.
BSF file can be loaded directly without loading any YAML file. This is an alternative route for
